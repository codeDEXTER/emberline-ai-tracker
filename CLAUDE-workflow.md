...
```bash
/Users/the-sponsor/apps/common-rules/bin/whoelse            # do I overlap with anyone?
/Users/the-sponsor/apps/common-rules/bin/whoelse --contested # batch view, before picking
```
