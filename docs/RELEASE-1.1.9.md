...
This patch fixes the hourly tracker graph. Progress snapshots now retain the
actual local commit time, so intraday updates appear at their real hourly
positions instead of collapsing into a flat midnight line.
