...
Difference from the prior run (/private/tmp/claude-501/-Users-aashish-apps/
...
(in every -Users-aashish-apps* project, including 3cff917f's own subagents
...
sys.path.insert(0, "/Users/aashish/apps/common-rules/tools")
import worklog as W
...
def main():
    ...
    for proj, sess, path in W.list_transcripts():
        if not proj.startswith("-Users-aashish-apps"):
            continue
