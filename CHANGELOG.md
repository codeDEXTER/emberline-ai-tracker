...
/Users/aashish/apps/common-rules`'s item 9 line, and `bin/warmup --project
/Users/aashish/apps/common-rules --no-recall --no-pull | grep -i ruflo`) --
...
lead runs it on `/Users/aashish/apps/PhotoVault` with the sponsor's approval.
